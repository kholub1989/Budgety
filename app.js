...
var budgetController = (function() {
  ...
  return {
    ...
    calculateBudget: function() {
      ...
      // Calculate total incam and expenses
      calculateTotal('exp');
      calculateTotal('inc');

      // Calculate the budget: incam - expenses
      data.budget = data.totals.inc - data.totals.exp;

      // Calculate the precentage of incam that we spend
      if (data.totals.inc > 0) {
        data.percentage = Math.round((data.totals.exp / data.totals.inc) * 100);
      } else {
        data.percentage = -1;
      }
      //Expense = 100 and incam 300, spend 33.333% = 100/300 = 0.3333 * 100
    },
...
var controller = (function(budgetCtrl, UICtrl) {
  ...
  var updatePrecentages = function() {
    ...
    //2. read % from the budet controller
  ...
  var ctrlDeleteItem = function(event) {
    ...
    if (itemID) {
      ...
      //1. delete the item fromthe data structure
